...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2023 at 07:59 AM
...
(1, 'admin', '$2y$10$nM4RsOkJwTtvTs8XY./HLOUpUXT6tygP8ct1H4mboXM/y9YBqsbLW');
...
(211, 1, 'Present', '2022-12-30', 6),
(212, 3, 'Present', '2022-12-30', 6),
(213, 4, 'Present', '2022-12-30', 6),
(214, 5, 'Absent', '2022-12-30', 6),
(215, 6, 'Absent', '2022-12-30', 6);
...
(6, 'Dr. A S Shukla', 'Clement town', 'asshukla@geu.com', '$2y$10$HhsVMNC6yi71Usf6bKcANebpwDbm8mIvxnkQdGZ7ngIjz62hknUMq', 'Phd.', '2022-12-01', '63aeb5591eaee.jpg', 6);
...
--
ALTER TABLE `tbl_attendance`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;
